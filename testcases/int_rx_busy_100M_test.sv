class int_rx_busy_100M_test extends eth_base_test;
  `uvm_component_utils(int_rx_busy_100M_test)

  function new(string name="int_rx_busy_100M_test", uvm_component parent);
