class full_100M_normal_pro_test extends eth_base_test;
  `uvm_component_utils(full_100M_normal_pro_test)

  function new(string name="full_100M_normal_pro_test", uvm_component parent);
