class full_100M_normal_bro_test extends eth_base_test;
  `uvm_component_utils(full_100M_normal_bro_test)

  function new(string name="full_100M_normal_bro_test", uvm_component parent);
