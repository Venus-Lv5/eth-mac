class full_100M_normal_multi_test extends eth_base_test;
  `uvm_component_utils(full_100M_normal_multi_test)

  function new(string name="full_100M_normal_multi_test", uvm_component parent);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    wdata_q.delete();
    wdata_q.push_back(32'h8000_0000);
