class full_10M_normal_multi_test extends eth_base_test;
  `uvm_component_utils(full_10M_normal_multi_test)

  function new(string name="full_10M_normal_multi_test", uvm_component parent);
