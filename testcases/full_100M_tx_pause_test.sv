class full_100M_tx_pause_test extends eth_base_test;
  `uvm_component_utils(full_100M_tx_pause_test)

  function new(string name="full_100M_tx_pause_test", uvm_component parent);
