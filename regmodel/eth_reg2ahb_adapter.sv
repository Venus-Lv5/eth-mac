class eth_reg2ahb_adapter extends uvm_reg_adapter;
  `uvm_object_utils(eth_reg2ahb_adapter)

  function new(string name="eth_reg2ahb_adapter");
    super.new(name);
  ...
  virtual function uvm_sequence_item reg2bus(const ref uvm_reg_bus_op rw);
    ...
    ahb.addr       = rw.addr;
    ahb.data       = rw.data;
    ahb.xfer_size  = ahb_transaction::HSIZE_WORD;
    ahb.burst_type = ahb_transaction::HBURST_SINGLE;
    ahb.num_beats  = 1;
    ahb.prot       = 4'h0;
  ...
  virtual function void bus2reg(uvm_sequence_item bus_item, ref uvm_reg_bus_op rw);
    ...
    rw.addr = ahb.addr;
    rw.data = ahb.data;
    rw.status = (ahb.resp == ahb_transaction::HRESP_ERROR) ? UVM_NOT_OK : UVM_IS_OK;
